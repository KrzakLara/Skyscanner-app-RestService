...
namespace RestServis.Controllers
{
    ...
    public class CarrierController : ControllerBase
    {
        ...
        private string path = "C:\\Users\\larak\\Desktop\\IIS\\Projekt_Lara\\RestService\\RestService\\Air_carriers_XSD.xsd";
        ...
        // XSD Validation
        [HttpPost("XSD")]
        public IActionResult Post(XmlElement xmlCarrier)
        {
            try
            {
                ...
                // Pridruži shemu s ispravnim namespace-om
                XmlNamespaceManager namespaceManager = new XmlNamespaceManager(document.NameTable);
                namespaceManager.AddNamespace("ns", nameSpace);
                document.Schemas.Add(namespaceManager.LookupNamespace("ns"), path);
